...
Site YAML and heightmaps come from the terrain-worker checkout
(TERRAIN_WORKER, or a sibling folder named road).
...
from paths import terrain_root  # noqa: E402
...
MAT_NAME = "portal_red"
SITES_DIR = terrain_root() / "config" / "sites"
...
def _processed_dir(site: dict) -> Path:
    ...
    return terrain_root() / "data" / "processed" / slug
...
<COLLADA xmlns="http://www.collada.org/2005/11/COLLADASchema" version="1.4.1">
  <asset>
    <contributor><authoring_tool>alpine-roadtrip build_portals</authoring_tool></contributor>
...
def patch_level_time_of_day(level_name: str, site: dict | None) -> None:
    if not site:
        ...
        return
    from level_tod import patch_time_of_day
